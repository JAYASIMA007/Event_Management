...
import { FaEye, FaEyeSlash } from 'react-icons/fa'; // Import icons - install with: npm install react-icons
...
const AdminRegister = () => {
  ...
  function handleRegister(_event: FormEvent<HTMLFormElement>): void {
